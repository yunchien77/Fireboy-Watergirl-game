...
//         gemsCollected ? RESOURCE_DIR
//         "/material/background/icon/result-pass.png"
//                       : RESOURCE_DIR
...
void App::GameWin() {
  ...
  // Determine which level button to update
  ...
  if (currentLevelButton) {
    // Choose image based on gem collection status
    std::string buttonImagePath =
        gemsCollected ? RESOURCE_DIR
            "/material/background/button/win2-level.png" // For successful
                                                         // gem collection
                      : RESOURCE_DIR
            "/material/background/button/win1-level.png"; // For failed gem
                                                          // collection
