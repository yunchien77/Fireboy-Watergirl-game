...
bool Level4::Initialize() {
    ...
    // 初始化Gem
    InitGems(GemType::FIRE, {{8, 3}, {23, 6}, {24, 12}, {13, 23}, {15, 16}, {36, 3}});
    InitGems(GemType::WATER, {{34, 14}, {29, 25}, {8, 11}, {26, 18}, {29, 8}, {11, 6}});

    // 初始化Trap
    InitLiquidTraps(CellType::WATER, SizeType::LARGE, {{11, 7}});
    InitLiquidTraps(CellType::WATER, SizeType::SMALL, {{34, 15}, {7, 17}, {12, 17}});
    InitLiquidTraps(CellType::LAVA, SizeType::LARGE, {{7, 4}});
    InitLiquidTraps(CellType::LAVA, SizeType::SMALL, {{21, 7}, {25, 7}});
    InitLiquidTraps(CellType::POISON, SizeType::LARGE, {{8, 27}, {17, 27}, {26, 27}});
