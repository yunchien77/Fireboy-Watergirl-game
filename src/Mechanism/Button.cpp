...
std::string Button::GetImagePath(ButtonColor color) {
    switch (color) {
        case ButtonColor::BLUE: return RESOURCE_DIR "/material/props/button/button-blue.png";
        case ButtonColor::GREEN: return RESOURCE_DIR "/material/props/button/button-green.png";
        case ButtonColor::ORANGE: return RESOURCE_DIR "/material/props/button/button-orange.png";
        case ButtonColor::PINK: return RESOURCE_DIR "/material/props/button/button-pink.png";
        case ButtonColor::WHITE: return RESOURCE_DIR "/material/props/button/button-white.png";
        case ButtonColor::YELLOW: return RESOURCE_DIR "/material/props/button/button-yellow.png";
    }
    return "";
}
