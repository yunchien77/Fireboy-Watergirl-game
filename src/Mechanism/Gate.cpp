...
std::string Gate::GetImagePath(GateColor color) {
    switch (color) {
        case GateColor::BLUE: return RESOURCE_DIR "/material/props/gate/gate-blue.png";
        case GateColor::GREEN: return RESOURCE_DIR "/material/props/gate/gate-green.png";
        case GateColor::ORANGE: return RESOURCE_DIR "/material/props/gate/gate-orange.png";
        case GateColor::PINK: return RESOURCE_DIR "/material/props/gate/gate-pink.png";
        case GateColor::WHITE: return RESOURCE_DIR "/material/props/gate/gate-white.png";
        case GateColor::YELLOW: return RESOURCE_DIR "/material/props/gate/gate-yellow.png";
    }
    return "";
}
